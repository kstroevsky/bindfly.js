...
export const LoaderTiles: FC<ILoaderTilesProps> = ({ radioCommand, position }) => {
    const clipPathForPosition = (position: string | number) => {
        ...
        switch (newPosition) {
            case 0: return 'inset(' + VAR1 + VAR2 + VAR1 + VAR0 + ' round 5%)';
            case 1: return 'inset(' + VAR0 + VAR2 + VAR2 + VAR0 + ' round 5%)';
            case 2: return 'inset(' + VAR0 + VAR1 + VAR2 + VAR1 + ' round 5%)';
            case 3: return 'inset(' + VAR1 + VAR1 + VAR1 + VAR1 + ' round 5%)';
            case 4: return 'inset(' + VAR2 + VAR1 + VAR0 + VAR1 + ' round 5%)';
            case 5: return 'inset(' + VAR2 + VAR0 + VAR0 + VAR2 + ' round 5%)';
            case 6: return 'inset(' + VAR1 + VAR0 + VAR1 + VAR2 + ' round 5%)';
            default: return '';
        }
    }
